...
export class addSizeInSponsor1605940938343 implements MigrationInterface {
    name = 'addSizeInSponsor1605940938343'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `sponsor` ADD `size` int NOT NULL DEFAULT 0");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `sponsor` DROP COLUMN `size`");
    }
