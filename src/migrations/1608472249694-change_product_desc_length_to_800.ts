...
export class changeProductDescLengthTo8001608472249694 implements MigrationInterface {
    name = 'changeProductDescLengthTo8001608472249694'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `product` ADD `description` varchar(800) NOT NULL");
